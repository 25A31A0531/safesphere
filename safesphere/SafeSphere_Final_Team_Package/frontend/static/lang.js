const TRANSLATIONS = {
    ...
    'es': {
        ...
        'about_desc': 'SafeSphere es un sistema totalmente impulsado por IA que funciona en cualquier lugar sin interacción del usuario y puede salvar vidas detectando emergencias en tiempo real.',
    ...
    'fr': {
        ...
        'desc': 'Détecte automatiquement les accidents, les incendies et les situations de panique n\'importe où et fournit une aide instantanée.',
        'login': 'Connexion',
        'signup': 'S\'inscrire',
        'about': 'À propos de SafeSphere',
        'about_desc': 'SafeSphere est un système entièrement basé sur l\'IA qui fonctionne n\'importe où sans interaction de l\'utilisateur et peut sauver des vies en détectant les urgences en temps réel.',
    ...
    document.querySelectorAll('[data-lang]').forEach(el => {
        ...
        if (dict[key]) {
            if (el.tagName === 'INPUT' && el.type === 'button') {
                ...
                // preserve inner HTML structure if needed, or just replace text.
                // For simplicity, we just set innerText or innerHTML if it has no complex children.
                // But safer to replace only text nodes or just use innerHTML for simple elements.
